    ...
    <div class="main-wrapper">
        ...
        <div class="section grey text-center m-t-60 p-t-40 p-b-40" id="banner-footer">
            <h2 class="normal m-b-10">
                We are a Social Media Consulatation Agency with smart thinking & smart work!</h2>
            <p>
        ...
        <div id="cbp-so-scroller" class="cbp-so-scroller section white ha-waypoint green-icons"
            ...
            <section class="cbp-so-section">
                <figure class="cbp-so-side cbp-so-side-left">
                    <img src="assets/img/condensed.png" alt="PPC Marketing">
                </figure>
                <article class="cbp-so-side cbp-so-side-right text-center middle">
                    <div class="row">
                        <div class="col-md-12 p-t-80 col-vlg-8 col-vlg-offset-2">
                            ...
                            <h1 class="m-b-20">
                                <span class="semi-bold">PPC</span> Marketing</h1>
                            <p>
            ...
            <section class="cbp-so-section">
                <article class="cbp-so-side cbp-so-side-left text-center middle">
                    <div class="row">
                        <div class="col-md-12 p-t-40 col-vlg-8 col-vlg-offset-2">
                            ...
                            <h1 class="m-b-20">
                                Content <span class="semi-bold">Creation</span></h1>
                            <p>
                ...
                <figure class="cbp-so-side cbp-so-side-right">
                    <img src="assets/img/cc.png" alt="img01">
                </figure>
            </section>
            <section class="cbp-so-section">
                <figure class="cbp-so-side cbp-so-side-left">
                    <img src="assets/img/mvd.png" alt="img01">
                </figure>
                <article class="cbp-so-side cbp-so-side-right text-center middle">
                    <div class="row">
                        <div class="col-md-12 p-t-80 col-vlg-8 col-vlg-offset-2">
                            ...
                            <h1 class="m-b-20">
                                <span class="semi-bold">Motion Video Design</span></h1>
                            <p>
            ...
            <section class="cbp-so-section">
                <article class="cbp-so-side cbp-so-side-left text-center middle">
                    <div class="row">
                        <div class="col-md-12 p-t-80 col-vlg-8 col-vlg-offset-2">
                            ...
                            <h1 class="m-b-20">
                                <span class="semi-bold">Product </span> Photography</h1>
                            <p>
                ...
                <figure class="cbp-so-side cbp-so-side-right">
                    <img src="assets/img/pp.png" alt="img01">
                </figure>
            </section>
            <section class="cbp-so-section">
                <figure class="cbp-so-side cbp-so-side-left">
                    <img src="assets/img/st.png" alt="PPC Marketing">
                </figure>
                <article class="cbp-so-side cbp-so-side-right text-center middle">
                    <div class="row">
                        <div class="col-md-12 p-t-80 col-vlg-8 col-vlg-offset-2">
                            <i class="fa fa-arrows-alt fa-4x"></i>
                            <h1 class="m-b-20">
                                <span class="semi-bold">Site </span>Testing</h1>
                            <p>
                                Intriguing web designs and fascinating results, makes you happy and earns us a loyal
                                customer – Always there, looking after you!
                            </p>
